...
:::: lecture
<lecture-title>Galaxy (\~20 min)</lecture-title>
...
[![日本語](assets/jp.svg){.flag width="25px"} Japanese version](https://training-galaxyproject-org.translate.goog/training-material/topics/introduction/tutorials/introduction/slides.html?_x_tr_sl=en&_x_tr_tl=ja&_x_tr_hl=en&_x_tr_pto=wapp)

{{< revealjs "https://training.galaxyproject.org/training-material/topics/introduction/tutorials/introduction/slides.html" >}}

::: reference
<reference-title>Reference</reference-title> This presentation is from the Galaxy Training Network (GTN): [*Introduction to Galaxy*](https://training.galaxyproject.org/training-material/topics/introduction/) Lizenz: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
:::
::::
...
If you would like to learn how to evaluate and analyse the output of `falco`{.tool} (or `fastqc`{.tool}, which is the predecessor of `falco`{.tool}) and `nanoplot`{.tool} yourself, you can do so in the following tutorial:\
...
## Upload data from NCBI to Galaxy
